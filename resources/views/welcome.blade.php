...
<body>
    <div class="chat">
        ...
        <!-- Header -->
        <div class="top">
            <img src="/pic/me.png" style="height: 100px; width: 100px" alt="Avatar">
            <div>
                <p>ASHIK RAHMAN</p>
                <small>Online</small>
            </div>
        ...
        <div class="messages">
            <div class="left message">
                <img src="/pic/chat-gpt.png" style="height: 50px; width: 50px" alt="Avatar">
